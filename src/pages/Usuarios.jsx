...
{ label: ‘Cadastro’,     valor: (usuario.data_cadastro || usuario.created_at) ? new Date(usuario.data_cadastro || usuario.created_at).toLocaleString(‘pt-BR’) : ‘—’ },
...
{(u.data_cadastro || u.created_at) ? new Date(u.data_cadastro || u.created_at).toLocaleDateString(‘pt-BR’) : ‘—’}
</td>
<td style={{ padding: ‘11px 14px’ }}>
...
return (
<>
<style>{`@keyframes spin { to { transform: rotate(360deg); } } @keyframes fadeIn { from { opacity: 0; transform: translateY(8px); } to { opacity: 1; transform: translateY(0); } } * { box-sizing: border-box; } .tabs-acoes { flex-direction: row; width: fit-content; } .tab-btn { width: auto; justify-content: center; } @media (max-width: 480px) { .tabs-acoes { flex-direction: column !important; width: 100% !important; } .tab-btn { width: 100% !important; justify-content: flex-start !important; } }`}</style>
