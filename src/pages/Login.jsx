    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F1F5F9] px-4">
      <div className="max-w-md w-full bg-white rounded-[40px] shadow-2xl p-10 border border-slate-100">
        <div className="text-center mb-12">
          {/* Logo Placeholder - Aqui entrará sua logo das imagens anexas */}
          ...
          <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">Metas<span className="text-blue-600">Pro</span></h1>
        ...
        <div className="relative my-10">
          ...
          <div className="relative flex justify-center text-xs uppercase"><span className="bg-white px-4 text-slate-400 tracking-widest">ou acesse com</span></div>
        </div>

        <button className="w-full py-4 border border-slate-200 rounded-2xl flex items-center justify-center gap-3 font-bold text-slate-600 hover:bg-slate-50 transition-all">
