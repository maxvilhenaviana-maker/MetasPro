  ...
  useEffect(() => {
    ...
    api.get('/onboarding/status')
      ...
      .catch(err => {
        ...
        // Se a chamada falhar por outro motivo, permite continuar
      })
  ...
  return (
    <Router>
      <Routes>
        ...
        {/* ── Onboarding — após login, antes de ter empresa/unidade ──────── */}
        <Route path="/onboarding" element={
          <PrivateRoute><Onboarding /></PrivateRoute>
        } />

        {/* ── TELA INICIAL — hub central pós-login ───────────────────────── */}
        <Route path="/inicial" element={
          <PrivateRouteWithOnboarding><Inicial /></PrivateRouteWithOnboarding>
        } />

        {/* ── Dashboard (acessado também via menu) ───────────────────────── */}
        ...
        {/* ── Raiz → redireciona para inicial (se logado) ou login ───────── */}
        <Route path="/" element={
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h1 style={{
              ...
              fontSize: 24, color: '#0f2d52', marginBottom: 8,
            }}>{titulo}</h1>
            ...
            {acaoInfo && (
              <div style={{
                ...
                fontSize: 13, fontWeight: 600, color: '#1d6fb8',
                marginBottom: 16,
              }}>
